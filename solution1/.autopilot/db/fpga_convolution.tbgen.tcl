set C_TypeInfoList {{ 
"fpga_convolution" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"image": [[], {"array": [ {"scalar": "int"}, [65536]]}] }, {"kernel": [[], {"array": [ {"scalar": "int"}, [121]]}] }, {"output": [[], {"array": [ {"scalar": "int"}, [65536]]}] }],[],""]
}}
set moduleName fpga_convolution
...
set C_modelName {fpga_convolution}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "image","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "image_r","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 65535,"step" : 1}]},{"cName": "kernel","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "kernel","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 120,"step" : 1}]},{"cName": "output","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "output_r","bundle": "AXILiteS"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 65535,"step" : 1}]}]}]} , 
 	{ "Name" : "image_r", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	...
 	{ "Name" : "output_r", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":32}, "offset_end" : {"in":39}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_AXILiteS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "AXILiteS", "role": "AWADDR" },"address":[{"name":"fpga_convolution","role":"start","value":"0","valid_bit":"0"},{"name":"fpga_convolution","role":"continue","value":"0","valid_bit":"4"},{"name":"fpga_convolution","role":"auto_start","value":"0","valid_bit":"7"},{"name":"image_r","role":"data","value":"16"},{"name":"kernel","role":"data","value":"24"},{"name":"output_r","role":"data","value":"32"}] },
	...
	{ "name": "s_axi_AXILiteS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "AXILiteS", "role": "ARADDR" },"address":[{"name":"fpga_convolution","role":"start","value":"0","valid_bit":"0"},{"name":"fpga_convolution","role":"done","value":"0","valid_bit":"1"},{"name":"fpga_convolution","role":"idle","value":"0","valid_bit":"2"},{"name":"fpga_convolution","role":"ready","value":"0","valid_bit":"3"},{"name":"fpga_convolution","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fpga_convolution_AXILiteS_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fpga_convolution_gmem_m_axi_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.empty_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fpga_convolution_cud_U0", "Parent" : "0"}]}
