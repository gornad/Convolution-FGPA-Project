...
typedef struct {
    ...
    XFpga_convolution_uio_map maps[ MAX_UIO_MAPS ];
} XFpga_convolution_uio_info;

/***************** Variable Definitions **************************************/
static XFpga_convolution_uio_info uio_info;
...
static int uio_info_read_name(XFpga_convolution_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XFpga_convolution_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XFpga_convolution_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XFpga_convolution_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XFpga_convolution_Initialize(XFpga_convolution *InstancePtr, const char* InstanceName) {
	XFpga_convolution_uio_info *InfoPtr = &uio_info;
