...
#ifndef __fpga_convolution_cud__HH__
#define __fpga_convolution_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fpga_convolution_cud) {
    ...
    SC_CTOR(fpga_convolution_cud):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
